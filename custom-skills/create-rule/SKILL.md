---
name: create-rule
description: Creates Cursor rules (.mdc files) for persistent AI guidance that automatically applies in future sessions. Use when: the user wants to create a rule or coding standard; the user says "always do X", "never do Y", "from now on", "remember to", "every time", "you should always", "make sure you always"; the user wants to persist a behavior or preference so they don't have to repeat it; the user asks to add project conventions or file-specific patterns; the user references .cursor/rules/ or AGENTS.md; or the user is tired of repeating the same instruction and wants it automated.
---
