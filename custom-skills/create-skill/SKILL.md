---
name: create-skill
description: Guides users through creating effective Agent Skills for Cursor — reusable instruction sets that teach the agent specialized workflows. Use when: the user wants to create, write, or author a new skill; asks about skill structure, best practices, or SKILL.md format; says "make a skill", "create a skill", "save this workflow", "teach you how to", "package this as a skill"; wants to save a repeatable workflow for future reuse so the agent can apply it automatically; or wants to encapsulate domain knowledge or a multi-step process into a reusable skill.
---
